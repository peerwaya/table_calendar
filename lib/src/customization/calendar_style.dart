...
class CalendarStyle {
  ...
  /// Style of foreground Text for days within `startDay` - `endDay` Date range.
  ...
  /// Background Color of available day.
  ...
  /// Specifies whether or not the available day should be highlighted.
  ...
  const CalendarStyle({
    ...
    this.availableColor = const Color(0xFF9FA8DA), // Material indigo[400]
